...
export class ContactsDetailsWithoutStateManagementComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _contactsListWithoutStateManagementComponent: ContactsListWithoutStateManagementComponent,
    ...
    {
        // Open the drawer
        this._contactsListWithoutStateManagementComponent.matDrawer.open();
    ...
    /*
     * Get contact the classic way
     */
    getAllContact() {
        this._contactsService.fetchContacts()
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(() => {
                // Mark for check
                this._changeDetectorRef.markForCheck();
    ...
    {
        return this._contactsListWithoutStateManagementComponent.matDrawer.close();
    }
    ...
    updateContact(): void
    {
        ...
        this._contactsService.updateContactClassicaly(contact.id, contact).subscribe(() => {
            // fetch all contact to get the edited one
            this.getAllContact()
    ...
    deleteContact(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if ( result === 'confirmed' )
            {
                ...
                // Delete the contact
                this._contactsService.deleteContactClassicaly(id)
                    .subscribe((isDeleted) => {
